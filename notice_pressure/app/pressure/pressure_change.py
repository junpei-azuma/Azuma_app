...
class PressureChange():
    ...
    def __init__(self, current_pressure: Pressure, pressure_3hour_ago: Pressure) -> None:
        """インスタンスを初期化する
    ...
    @classmethod
    def validate_datetime_difference(cls, current_pressure: Pressure, pressure_3hour_ago: Pressure) -> bool:
        ...
        return time_difference_hour == __MAX_INTERVAL or time_difference_hour == __MIN_INTERVAL
